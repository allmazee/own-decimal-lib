...
START_TEST(negate_0) {
  ...
  s21_decimal res = {0};
  int sign_before = s21_sign(val);
  s21_negate(val, &res);
  int sign_after = s21_sign(res);
...
START_TEST(from_float_to_decimal_6) {
  s21_decimal val = {{0, 0, 0, 0}};
  float res = 0.;
  float right_res = -1.2e-27;
  float tmp = -1.230000e-27;
  s21_from_float_to_decimal(tmp, &val);
  printf(" ");
  s21_from_decimal_to_float(val, &res);
  ck_assert_float_eq(res, right_res);
}
END_TEST
...
START_TEST(from_float_to_decimal_7) {
  s21_decimal val = {{0, 0, 0, 0}};
  float res = 0.;
  float right_res = -1.3e-27;
  float tmp = -1.270000e-27;
  s21_from_float_to_decimal(tmp, &val);
  printf(" ");
  s21_from_decimal_to_float(val, &res);
  ck_assert_float_eq(res, right_res);
...
START_TEST(from_float_to_decimal_9) {
  s21_decimal val = {{0, 0, 0, 0}};
  float res = 0.;
  float right_res = 1.234568e20;
  float tmp = 12345678912e10;
  s21_from_float_to_decimal(tmp, &val);
  printf(" ");
  s21_from_decimal_to_float(val, &res);
  ck_assert_float_eq(res, right_res);
...
int main(void) {
  ...
  tcase_add_test(tc1_1, div_0);  // div
  tcase_add_test(tc1_1, div_1);
  tcase_add_test(tc1_1, mul_0);  // mul
